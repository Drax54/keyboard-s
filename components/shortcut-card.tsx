...
// import { ShortcutCardProps } from "@/data/types";
// import { Card } from "@/components/ui/card";
// import { cn } from "@/lib/utils";
// import { Apple } from "lucide-react";
...
//   return (
//     <Card className="p-3 sm:p-4 transition-shadow hover:shadow-md hover:bg-accent rounded-lg">
//       <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
//         {/* Shortcut Description */}
//         <p className="text-base sm:text-lg font-normal flex-1">
//           {shortcut.description}
//         </p>
...
export function ShortcutCard({
  ...
  const displayKeys = isUniversal
    ? shortcut.platforms?.universal // Check if platforms exist before accessing universal
    : shortcut.platforms?.[platform]
    ? shortcut.platforms[platform]
    : shortcut.keys || [];
