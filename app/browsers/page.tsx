...
// // Pre-compute the browsers array
...
//               {filteredBrowsers.length} result{filteredBrowsers.length !== 1 ? "s" : ""}
//             </div>
//           )}
//         </div>
//       </div>
...
import { browsers } from "@/data/browsers";
import BrowsersClient from "./browsers-client";

// Convert the browsers object into an array once
const browsersArray = Object.values(browsers);
...
export const metadata: Metadata = {
  ...
  title: "Browser Shortcuts - Master Web Navigation | Boost My Key",
  description: "Discover essential keyboard shortcuts for popular web browsers to enhance your browsing experience.",
...
export default function BrowsersPage() {
  return (
    <div className="px sm:px-6 lg:px-8 py-6 sm:py-10">
      <BrowsersClient browsersArray={browsersArray} />
    </div>
  );
}